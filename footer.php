	<footer class="footer">
        <div class="section container">
            ...
            <div class="copyright">
                <!-- <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/wheel.png" class="float-left"> -->
                <!-- <p><strong>Thanks to our <a class="copyright__link" href="#">Sponsors</a><br/>Website Design by <a class="copyright__link" href="">The Childress Agency</a></strong></p> -->
